 ...
 * MBeans with both password file based security and ssl based security enabled. 
 * 
 ...
 */
public class TestIBMJlmRemoteMemoryAuth implements StfPluginInterface {
	
	FileRef keyStoreFile;
	FileRef passwordFile;
			
	public void help(HelpTextGenerator help) throws StfException {
		help.outputSection("IBM JLM Remote memory test with security");
	...
	public void execute(StfCoreExtension test) throws StfException {
		...
		FileRef logFile	= resultsDir.childFile("smem_proxy.log");
		FileRef statsFile = resultsDir.childFile("smem_proxy.csv");
		...
		StfProcess clientProxy = test.doRunBackgroundProcess("Running Monitoring Client with proxy connection(with security)", 
				"CL1", ECHO_ON,  
