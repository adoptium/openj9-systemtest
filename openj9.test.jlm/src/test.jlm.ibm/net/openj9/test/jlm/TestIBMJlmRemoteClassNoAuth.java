 ...
 */
public class TestIBMJlmRemoteClassNoAuth implements StfPluginInterface {
	
	public void help(HelpTextGenerator help) throws StfException {
		help.outputSection("IBM JLM Remote Class test");
		help.outputText("These tests exercise com.ibm.lang.management APIs (Class related beans) "
