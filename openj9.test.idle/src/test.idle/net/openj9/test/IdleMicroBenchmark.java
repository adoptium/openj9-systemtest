...
public class IdleMicroBenchmark {
	...
	public void runTest(String testArg) throws MalformedObjectNameException, IOException {
		String[] testArgs = new String[]{testArg};
		new IdleMicroBenchmark();
		IdleMicroBenchmark.main(testArgs);
	}
